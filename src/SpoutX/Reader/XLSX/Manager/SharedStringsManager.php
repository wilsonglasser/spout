...
use SpoutX\Reader\XLSX\Creator\HelperFactory;
...
use SpoutX\Reader\XLSX\Manager\SharedStringsCaching\CachingStrategyInterface;
...
class SharedStringsManager
{
     ...
     *
     * @throws \SpoutX\Common\Exception\IOException If shared strings XML file can't be read
     * @return void
     */
     ...
     *
     * @param \SpoutX\Reader\Wrapper\XMLReader $xmlReader XMLReader instance
     * @throws \SpoutX\Common\Exception\IOException If sharedStrings.xml is invalid and can't be read
     ...
     *
     * @param \SpoutX\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on a "<si>" node
