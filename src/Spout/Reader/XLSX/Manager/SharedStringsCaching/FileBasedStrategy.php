...
namespace WilsonGlasser\Spout\Reader\XLSX\Manager\SharedStringsCaching;

use WilsonGlasser\Spout\Reader\Exception\SharedStringNotFoundException;
...
class FileBasedStrategy implements CachingStrategyInterface
{
    ...
    /** @var \WilsonGlasser\Spout\Common\Helper\FileSystemHelper Helper to perform file system operations */
