...
use WilsonGlasser\Spout\Reader\Exception\InvalidValueException;
use WilsonGlasser\Spout\Reader\Exception\XMLProcessingException;
use WilsonGlasser\Spout\Reader\IteratorInterface;
use WilsonGlasser\Spout\Reader\Wrapper\XMLReader;
use WilsonGlasser\Spout\Reader\XLSX\Creator\InternalEntityFactory;
use WilsonGlasser\Spout\Reader\XLSX\Helper\CellHelper;
use WilsonGlasser\Spout\Reader\XLSX\Helper\CellValueFormatter;
...
class RowIterator implements IteratorInterface
{
    ...
    /** @var \WilsonGlasser\Spout\Reader\Common\XMLProcessor Helper Object to process XML nodes */
    protected $xmlProcessor;

    /** @var Helper\CellValueFormatter Helper to format cell values */
    protected $cellValueFormatter;

    /** @var \WilsonGlasser\Spout\Reader\Common\Manager\RowManager Manages rows */
    protected $rowManager;

    /** @var \WilsonGlasser\Spout\Reader\XLSX\Creator\InternalEntityFactory Factory to create entities */
     ...
     *
     * @throws \WilsonGlasser\Spout\Reader\Exception\SharedStringNotFoundException If a shared string was not found
    ...
    /**
     * @param \WilsonGlasser\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<dimension>" starting node
    ...
    /**
     * @param \WilsonGlasser\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<row>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \WilsonGlasser\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
    ...
    /**
     * @param \WilsonGlasser\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<row>" node
     * @throws \WilsonGlasser\Spout\Common\Exception\InvalidArgumentException When the given cell index is invalid
    ...
    /**
     * @param \WilsonGlasser\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<c>" node
     * @throws \WilsonGlasser\Spout\Common\Exception\InvalidArgumentException When the given cell index is invalid
