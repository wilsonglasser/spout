...
class RowIterator implements IteratorInterface
{
    ...
    /** @var \WilsonGlasser\Spout\Common\Helper\EncodingHelper Helper to work with different encodings */
    protected $encodingHelper;

    /** @var \WilsonGlasser\Spout\Reader\CSV\Creator\InternalEntityFactory Factory to create entities */
