...
namespace WilsonGlasser\Spout\Reader\ODS;
...
use WilsonGlasser\Spout\Reader\Exception\IteratorNotRewindableException;
use WilsonGlasser\Spout\Reader\Exception\XMLProcessingException;
use WilsonGlasser\Spout\Reader\IteratorInterface;
use WilsonGlasser\Spout\Reader\ODS\Creator\InternalEntityFactory;
...
class RowIterator implements IteratorInterface
{
     ...
     *
     * @throws \WilsonGlasser\Spout\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     * @return void
     */
    ...
    /**
     * @param \WilsonGlasser\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-row>" starting node
    ...
    /**
     * @param \WilsonGlasser\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
