...
use WilsonGlasser\Spout\Common\Exception\EncodingConversionException;
...
class EncodingHelper
{
    ...
    /**
     * @param \WilsonGlasser\Spout\Common\Helper\GlobalFunctionsHelper $globalFunctionsHelper
     */
     ...
     * @throws \WilsonGlasser\Spout\Common\Exception\EncodingConversionException If conversion is not supported or if the conversion failed
