...
interface WriterInterface
{
     ...
     * @throws \WilsonGlasser\Spout\Common\Exception\IOException If the writer cannot be opened or if the given path is not writable
     ...
     * @throws \WilsonGlasser\Spout\Common\Exception\IOException If the writer cannot be opened
     * @return WriterInterface
     */
     ...
     * @throws \WilsonGlasser\Spout\Writer\Exception\WriterNotOpenedException If the writer has not been opened yet
     * @throws \WilsonGlasser\Spout\Common\Exception\IOException If unable to write data
     * @return WriterInterface
     */
     ...
     * @throws \WilsonGlasser\Spout\Common\Exception\InvalidArgumentException If the input param is not valid
     * @throws \WilsonGlasser\Spout\Writer\Exception\WriterNotOpenedException If the writer has not been opened yet
     * @throws \WilsonGlasser\Spout\Common\Exception\IOException If unable to write data
     * @return WriterInterface
     */
