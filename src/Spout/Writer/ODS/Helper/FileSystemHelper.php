...
namespace WilsonGlasser\Spout\Writer\ODS\Helper;
...
class FileSystemHelper extends \WilsonGlasser\Spout\Common\Helper\FileSystemHelper implements FileSystemWithRootFolderHelperInterface
{
     ...
     *
     * @throws \WilsonGlasser\Spout\Common\Exception\IOException If unable to create the folder or the "manifest.xml" file
     * @return FileSystemHelper
     */
